...
public class BasicoTest {
	...
	public static void setUpBeforeClass(){
		System.out.println("SetUp do BeforeClass: uma unica vez");
	}
	@BeforeClass
	public static void contadorBeforeClass(){
		contador++;
	...
	public static void tearDownAfterClass(){
		System.out.println("Tear Down do AfterClass: uma unica vez");
	}
	...
	public void testDividirPorZero_regra(){
		...
		assertEquals(negocio.dividir("10", "0"), 10, 0);
	}
	
	@Ignore("Nao lembro como faz isso")
	@Test
	public void testMDC(){
